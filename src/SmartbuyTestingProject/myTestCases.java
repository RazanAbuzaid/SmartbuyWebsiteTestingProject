...
public class myTestCases {
	...
	public void SignUp() {
		...
		WebElement CreatMyAccountButton=driver.findElement(By.cssSelector(".form__submit.button.button--primary.button--full"));
...
MyAccount.click();
		WebElement LogoutButton=driver.findElement(By.cssSelector("div[class='card card--sticky hidden-pocket'] a:nth-child(3)"));
		LogoutButton.click();
		String headerMessage=driver.findElement(By.cssSelector(".header__action-item-title.hidden-pocket.hidden-lap")).getText();
